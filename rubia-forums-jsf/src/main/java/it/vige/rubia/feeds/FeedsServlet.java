...
import static it.vige.rubia.util.PortalUtil.VIEW;
import static it.vige.rubia.util.PortalUtil.getIdForName;
import static it.vige.rubia.util.PortalUtil.getNameForId;
