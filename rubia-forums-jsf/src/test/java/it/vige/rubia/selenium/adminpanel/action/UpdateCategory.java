...
public class UpdateCategory {
	...
	public static String updateCategory(WebDriver driver, CategoryBean oldCategory, CategoryBean newCategory) {
		...
		WebElement updateCategoryLink = driver
				.findElement(xpath("//td[strong/text()='" + oldCategory.getTitle() + "']/form[2]/a"));
		updateCategoryLink.click();
		WebElement updateCategoryNameInputText = driver.findElement(xpath(UPDATE_CATEGORY_NAME_INPUT_TEXT));
		updateCategoryNameInputText.clear();
		updateCategoryNameInputText.sendKeys(newCategory.getTitle());
		WebElement updateCategoryButton = driver.findElement(xpath(UPDATE_CATEGORY_BUTTON));
		updateCategoryButton.click();
		WebElement resultUpdateCategory = driver.findElement(className(RESULT_UPDATE_CATEGORY));
