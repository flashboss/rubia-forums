...
public class PreferencesTest {
	...
	public void setUp() {
		...
		forum = new Forum("Fifth Test Forum", "Fifth Test Description", new Category("Second Test Category"));
		message = createForum(driver, forum);
	...
	public void scenary1() {
		...
		assertEquals(topics.get(0).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(1).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(2).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(3).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(4).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(5).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(6).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(7).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(8).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(9).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(10).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(11).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(12).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(13).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(14).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(15).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(16).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(17).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(18).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(19).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(20).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(21).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(22).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(23).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(0).getPosts().get(24).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(1).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(2).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(3).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(4).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(5).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(6).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(7).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(8).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(9).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(10).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(11).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(12).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(13).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(14).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(15).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(16).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(17).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(18).getPosts().get(0).getPoster().getUserId(), "root");
	...
	public void scenary2() {
		...
		assertEquals(topics.get(0).getPosts().get(0).getMessage().getText(), "Ninteen Test Body");
		assertTrue(topics.get(0).getPosts().get(0).getCreateDate().compareTo(today) < 0);
		assertEquals(topics.get(0).getPosts().get(0).getPoster().getUserId(), "root");
		assertTrue(topics.get(0).getPosts().get(1).getMessage().getSubject().startsWith(RE + "Ninteen Test Topic"));
		assertEquals(topics.get(0).getPosts().get(1).getMessage().getText(),
		...
		assertEquals(topics.get(19).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(20).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(21).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(22).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(23).getPosts().get(0).getPoster().getUserId(), "root");
		message = removeTopic(driver,
				new Topic(new Forum("Third Test Forum", "Third Test Description", new Category("Second Test Category")),
						"Thirtytwo Test Topic", asList(new Post[] { new Post("Thirtytwo Test Body") }), NORMAL, null));
		assertTrue(message.equals(OK));
	...
	public void scenary3() {
		...
		assertEquals(topics.get(24).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(25).getPosts().get(0).getPoster().getUserId(), "root");
		...
		assertEquals(topics.get(26).getPosts().get(0).getPoster().getUserId(), "root");
		message = removeTopic(driver,
				new Topic(new Forum("Third Test Forum", "Third Test Description", new Category("Second Test Category")),
						"Thirtytwo Test Topic", asList(new Post[] { new Post("Thirtytwo Test Body") }), NORMAL, null));
		assertTrue(message.equals(OK));
