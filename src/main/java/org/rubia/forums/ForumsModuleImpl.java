 ...
 ******************************************************************************/
package org.rubia.forums;

import static org.rubia.forums.ui.Constants.POST_ANNOUNCE;
import static org.rubia.forums.ui.Constants.TOPIC_UNLOCKED;
import static org.rubia.forums.util.NotificationEngine.MODE_POST;
import static org.rubia.forums.util.NotificationEngine.MODE_REPLY;
...
import org.rubia.forums.log.ForumsModuleImplLog;
import org.rubia.forums.model.Attachment;
import org.rubia.forums.model.Category;
import org.rubia.forums.model.Forum;
import org.rubia.forums.model.ForumInstance;
import org.rubia.forums.model.ForumWatch;
...
import org.rubia.forums.model.TopicWatch;
import org.rubia.forums.model.Watch;
import org.rubia.forums.util.NotificationEngine;
...
public class ForumsModuleImpl implements ForumsModule {
	 ...
	 */
	private List<Topic> findTopics(Forum forum, int type, int start, int perPage, String order) throws ModuleException {
		try {
	...
	public List<Topic> findTopicsAsc(Forum forum, int type, int start, int perPage) throws ModuleException {
		return findTopics(forum, type, start, perPage, "asc");
	}

	public List<Topic> findTopicsDesc(Forum forum, int type, int start, int perPage) throws ModuleException {
	...
	public List<Topic> findTopicsBefore(Forum forum, int type, int start, int perPage, Date date) throws ModuleException {
		return null;
	}
	...
	public Topic createTopic(Forum forum, String userId, String subject, int type) throws ModuleException {
		try {
	...
	private List<Post> findPostsByIdsFetchAttachmentsAndPosters(Collection<Post> posts, String order) throws ModuleException {
