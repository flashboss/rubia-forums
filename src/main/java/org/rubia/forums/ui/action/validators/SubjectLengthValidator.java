...
import static org.rubia.forums.ui.action.validators.ValidatorMessages.SUBJECT_LENGTH_ERROR;
 ...
 * 
 */
@FacesValidator("subjectLengthValidator")
public class SubjectLengthValidator extends LengthValidator {

	protected String getMessage() {
		return SUBJECT_LENGTH_ERROR;
	}
