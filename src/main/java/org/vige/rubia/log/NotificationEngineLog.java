 ...
 ******************************************************************************/
package org.vige.rubia.log;

import static org.jboss.solder.logging.Logger.Level.ERROR;
import static org.jboss.solder.logging.Logger.Level.WARN;
...
@MessageLogger
public interface NotificationEngineLog {
	
    @Log(level = ERROR)
    @Message("Aviability for error with code %s: %s.")
