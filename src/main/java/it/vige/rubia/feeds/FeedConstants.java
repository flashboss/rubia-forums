...
public class FeedConstants {
    ...
    public static final String URL_INIT_PARAM_NAME = "it.vige.rubia.feeds.URL";
    
    public static final String URL_TYPE_INIT_PARAM_NAME = "it.vige.rubia.feeds.URL_TYPE";
